document.addEventListener("DOMContentLoaded", () => {
  ...
  // ✅ 눈 / 코 / 귀 / 입 팝업 생성
  createPopup(".eye-zoom", "eye-popup", "img/eye.png", "눈 확대 이미지");
  createPopup(".nose-zoom", "nose-popup", "img/nose.png", "코 확대 이미지");
  createPopup(".ear-zoom", "ear-popup", "img/ear.png", "귀 확대 이미지");
  createPopup(".mouth-zoom", "mouth-popup", "img/lip.png", "입술 확대 이미지");
});
